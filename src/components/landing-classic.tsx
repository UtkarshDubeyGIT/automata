...
/** The previous "living automation desk" landing, kept intact so the site can switch back with one import. */
export function ClassicLanding() {
  return (
    <main className="marketing-shell automata-site theme-light">
