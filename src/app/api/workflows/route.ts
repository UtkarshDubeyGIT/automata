...
export async function POST(request: NextRequest) {
  ...
  const body = await request.json().catch(() => ({})) as { workspaceId?: string; templateId?: string; name?: string; description?: string; graph?: WorkflowGraph; allowUnattendedWrites?: boolean };
